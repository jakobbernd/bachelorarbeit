...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.3\textwidth}
        ...
        \begin{tikzcd}
            T \ar[rd,"\id_T"',Rightarrow,sloped] \ar[r, "\eta T",Rightarrow] 
        & T^2 \ar[d,"\mu",Rightarrow] 
        & T \ar[l,"T \eta"',Rightarrow] \ar[ld,"\id_T"',Rightarrow,sloped]\\
        & T
        \end{tikzcd}
        \caption*{(unitality)}
    \end{subfigure} 
...
%\phantomsection\label{name2}
\begin{tikzcd}
    Tx \ar[rd,"\id_{Tx}"',sloped] \ar[r, "\eta_{Tx}"] 
    & T(Tx) \ar[d,"\mu_x"] 
    & Tx \ar[l,"T(\eta_x)"'] \ar[ld,"\id_{Tx}"',sloped]\\
    & Tx
\end{tikzcd}
\caption*{(unitality)}
\end{subfigure}
...
A \textit{comonad} in $\cat{A}$ is a monad in $\cat{A}^{op}$. Explicitly:
...
%\phantomsection\label{name2}
    \begin{tikzcd} 
        & L \ar[ld,"\id_L",Rightarrow,sloped] 
        \ar[rd,"\id_L",Rightarrow,sloped] \ar[d,"\omega",Rightarrow] & \\
        L 
...
%\phantomsection\label{name2}
    \begin{tikzcd}
        & Lx \ar[ld,"\id_{Lx}",sloped] 
        \ar[rd,"\id_{Lx}",sloped] \ar[d,"\omega_x"] & \\
        Lx 
...
We now consider another example of a comonad; the \textit{free monoid ring comonad}.
...
\begin{lemma}[Interchange law] \label{lem: interchange law}
...
\begin{definition}[Morphism of monads]
    ...
    %\phantomsection\label{name1}
    \begin{tikzcd}
        \id_X \ar[rd,"\eta'"',Rightarrow] \ar[r, "\eta",Rightarrow] 
...
\begin{example}
    ...
    %\phantomsection\label{name1}
        \begin{tikzcd}
            X \ar[r,"\eta_X"] \ar[rd,"\eta'_X"']
            & X \sqcup \set{\ast} \ar[d,"\delta_x"] \\
            & \P^1(X)
        \end{tikzcd}
    %\caption*{(cap1)}
    \end{subfigure}
    ...
    %\phantomsection\label{name2}
    \begin{tikzcd}
        X \sqcup \set{\ast_1} \sqcup \set{\ast_2} \arrow[r,"\mu_X"] \arrow[d,"(\delta \tensor \delta)_X"] 
          & X \sqcup \set{\ast_1} \arrow[d,"\delta_X"] \\
        \P^1(\P^1(X)) \arrow[r,"\mu'_X"]
          & \P^1(X)
    \end{tikzcd}
    %\caption*{(cap2)}
    \end{subfigure}
...
\begin{example}[Galois connection]
    ...
    \begin{itemize}[topsep = 0pt,noitemsep]
        ...
        \begin{tikzcd}[cramped]
            \cat{S}
                \arrow[r,"F"{name=D},shift left = .60ex]
              & \cat{C} \arrow[l,"G"{name=C},shift left = .60ex]
        \end{tikzcd}
...
%\phantomsection\label{name1}
\begin{tikzcd}
    Tx \ar[r,"T\eta_x"] \ar[rd,"\id_{Tx}"',sloped]
    & T^2x \ar[d,"\mu_x"] \\
    & Tx 
\end{tikzcd}
%\caption*{(cap1)}
...
\begin{beweis}   
    ...
    \begin{smallproof}
        ...
        %\phantomsection\label{name2}
        \begin{tikzcd}
            Ga \ar[r,"\eta_{Ga}"] \ar[rd,"\id_{Ga}"',sloped]
            & GFGa \ar[d,"G(\eps_a)"] \\
            & Ga 
        \end{tikzcd}
        %\caption*{(cap2)}
...
\begin{example}[M-action monad]
    ...
    \begin{tikzcd}[cramped]
        X \arrow[r,"k"]
          & Y \times M \arrow[r,"h \times \id_M"]
            & Z \times M \times M \arrow[r,"\mu_x"]
              & Z \times M
    \end{tikzcd}
...
\begin{beweis}
    ...
    %\phantomsection\label{name1}
    \begin{tikzcd}
        F_Tx \ar[r,"F_T(\eta_x)"] \ar[rd,"\id_{F_Tx}"',sloped]
    ...
    %\phantomsection\label{name2}
    \begin{tikzcd}
        G_Tx_T \ar[r,"\eta_{G_Tx_T}"] \ar[rd,"\id_{G_Tx_T}"',sloped]
