...
\begin{bigproof}
    ...
    = \overline{f^p}$ in $\Fp[a_n,b_n \mid n \in S]$, which is apparent). \todo{is is though?}
    \begin{claim*}
    ...
    \begin{align*}
        ...
        \phi_p(w_{n/p}(a) \cdot w_{n/p}(b))
            ...
            \cdot a_{d_1}^{n/d_1} \cdot b_{d_2}^{n/d_2} 
    \end{align*}
    \todo{is this computation correct?}
...
\begin{beweis}
    ...
    In the general case: \todo{general case}
\end{beweis}
...
\begin{proof}[Proof of Lemma~\ref*{lem: frobenius}]
    ...
    \[
        ...
        \end{tikzcd}
    \]
    commutes, but it again suffices to show \todo{why?} that it commutes after
